...
# ----------------------------------------
# If pll_clk_50 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.1 991 linux 2024.03.25.21:14:21
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/seyedh/intelFPGA_lite/23.1std/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_clk_50.vho"
}
