...
TOP_LEVEL_NAME="pll_clk_50"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/seyedh/intelFPGA_lite/23.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_clk_50.vho"
fi
